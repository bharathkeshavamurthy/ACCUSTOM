...
g, n_u, n_g, n_c, n_a_u, n_a_g, wgt_uav, v_h_max, v_v_max = constants.g, 6, 36, 6, 16, 4, 80, 30, 30
...
v_min, v_max, v_p_min, tx_p, beta_0, w_var = 0, 30, 20.1, dbm_watts(23), db_watts(20), constants.Boltzmann * temp * bw
