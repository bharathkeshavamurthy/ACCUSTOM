...
g, n_u, n_g, n_c, n_a_u, n_a_g, m_u, v_h_max, v_v_max = 9.8, 6, 36, 6, 16, 4, 3, 55, 55
...
ex_vec, ey_vec, ez_vec, v_min, v_p_min = np.array([1, 0, 0]), np.array([0, 1, 0]), np.array([0, 0, 1]), 0, 22
...
assert n_c == n_u, 'The number of UAVs should be equal to the number of GN clusters for this IBF static UAV deployment!'
