...
v_min, v_stp, v_p_min, tx_p, beta_0, w_var = 0, 0.1, 16.8, dbm_watts(23), db_watts(20), constants.Boltzmann * temp * bw
...
assert n_c == n_u, 'The number of UAVs should be equal to the number of GN clusters for this IBF deployment!'
...
So, here in this IBF framework, to maintain consistency across comparisons, if a UAV nears a collision 
