...
v_v_max, ss_cnt, wgt_uav, tx_p, beta_0, w_var = 55, 9, 80, dbm_watts(23), db_watts(20), constants.Boltzmann * temp * bw
g, n_u, n_g, n_c, n_a_u, n_a_g, v_min, v_p_min, v_max, v_num, v_stp = constants.g, 6, 36, 8, 16, 4, 0, 20.1, 55, 25, 0.1
v_h_max, t_min, t_max, x_max, y_max, z_max, x_d, y_d, z_d, h_g, n_ss = 55, 300, 3000, 5000, 5000, 200, 5, 5, 5, None, 60
